...
export default function AdminLayout({
  ...
  const handleWhatsAppSupport = () => {
    ...
    const message =
      "Hello, I need support regarding the Lost and Found system.";
    ...
    <div className="admin-shell">
      <aside className="admin-sidebar">
        ...
        <div className="admin-sidebar-actions">
          <button
            className="admin-side-btn admin-side-btn--whatsapp"
          ...
          <button
            className="admin-side-btn admin-side-btn--logout"
