            ...
            asLostOwner.map((match) => {
              ...
              return (
                <article key={match._id} className="match-card">
                  <div
                    className={`match-card-ribbon match-card-ribbon--${claimed ? 'claimed' : notified ? 'ready' : 'await'
                      }`}
                  >
            ...
            >
              ...
              <div className="respond-modal-fields">
                ...
                <input
                  ...
                  className="respond-modal-input"
                  value={contactPhone}
                  // This regex filters out everything except digits 0-9
                  onChange={(e) => {
                  ...
                  autoComplete="tel"
                  // Optional: helps mobile keyboards show the number pad
                  inputMode="numeric"
                />
              </div>
